...
// <a
//   href="#"
//   className="group shadow-md m-1 rounded-lg border-gray-300 px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
//   target="_blank"
//   rel="noopener noreferrer"
// >
//   <Image src={item.imageUrls[0]} alt={item.name} height={300} width={300} />
